...
<center><h2>Teacher Sign Up</h2></center>
 <form action="TeacherSignupServlet" id="ContactUsCaptchaWebForm" method="post" onsubmit="return formdata(this);">
 ...
 <td><b>Gender:</b></td>
 <td><input name="gender" type="radio" />Male &nbsp; <input name="gender" type="radio" />Female</td>
 </tr><tr>
